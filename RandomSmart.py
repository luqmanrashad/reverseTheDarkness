...
while board1.enemyScore != 0:
    ...
    firstMissing = board1.missingBlocks()
    board1.makeMove(firstMissing[0], firstMissing[1], 1)
    moves += 1
    ...
    if random.randrange(1,10) == random.randrange(1,10):
        ...
        secondMissing = board1.missingBlocks()
        board1.makeMove(secondMissing[0], secondMissing[1], 1)
        board1.bonusTag = 0
        moves += 1
    board1.printBoard()
    wn.clear()
